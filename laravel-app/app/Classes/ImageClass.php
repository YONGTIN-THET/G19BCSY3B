...
class ImageClass
{
    ...
    public function __construct(
        ...
        if (!$resolvedDisk instanceof FilesystemAdapter) {
            throw new \RuntimeException(
                'Configured disk must resolve to FilesystemAdapter.'
            );
        }
    ...
    public function store(UploadedFile $image): string
    {
        ...
        if (!$sourcePath) {
            throw new \RuntimeException(
                'Uploaded image source path is invalid.'
            );
        }
    ...
    public function delete(?string $imagePath): void
    {
        ...
        if (
            $thumbnailPath &&
            $this->disk->exists($thumbnailPath)
        ) {
    ...
    private function createThumbnail(
        ...
        $encoded =
            $thumbnail->encodeUsingFileExtension($extension);
